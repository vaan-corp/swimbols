    ...
    ScrollView {
      VStack(alignment: .leading, spacing: 15) {
        Text("Terms of Use")
          ...
          .centerHorizontally()
        Text("""
            Swimbols provides a swifty and fun way to work with SF Symbols. Do the searching, designing \
            and then changing symbols all in one place, and take your code with you.
            
            You can use Swimbols for free with limited features. You can upgrade to Swimbols Pro to unlock all  \
            features by opting for a monthly subscription or an yearly subscription. Initially, for a limited \
            period, we are also providing a launch offer - a one time purchase.
            
            You can cancel anytime 24 hours before the end of the current period, so that you will not be charged for \
            the next period.
            """)
